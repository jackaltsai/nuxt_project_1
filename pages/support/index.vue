    ...
    <div class="bg-white py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">各項協助資源</h2>
        ...
        <div class="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          ...
          <!-- <article v-for="post in posts" :key="post.id" class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80"> -->
            ...
            <h3 class="mt-3 text-lg font-semibold leading-6 text-white">
              <a href="https://www.laf.org.tw/index.php">
          ...
          <!-- <article v-for="post in posts" :key="post.id" class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-80 sm:pt-48 lg:pt-80"> -->
            ...
            <h3 class="mt-3 text-lg font-semibold leading-6 text-white">
              <a href="https://www.laf.org.tw/service-legal-advice-tel">
                <span class="absolute inset-0" />
                被害人法律諮詢
              </a>
            </h3>
